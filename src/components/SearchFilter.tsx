...
const SearchFilter: React.FC<SearchFilterProps> = ({ filters }) => {
  ...
  return (
    <div className=" p-4 rounded-md h-auto">
      ...
      <button
        className="text-white px-3 py-2 rounded-md hover:bg-indigo-500 transition-colors duration-300 border-indigo-500 border-2 mt-2 text-indigo-500 font-medium text-xs float-right"
        onClick={handleReset}
      >
        Reset
      </button>
