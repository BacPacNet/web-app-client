    ...
    <>
      <div className={`py-10 px-12 flex flex-col gap-16 `}>
        <div className="flex flex-col gap-10">
          <h6 onClick={() => setAccountVerified(!accountVerified)} className="font-bold text-lg">
          ...
          {!accountVerified ? (
            ...
            <div className="flex flex-col gap-6 justify-center items-center">
              ...
              <input
                className="border-2 border-[#E5E5E5] w-80 h-10 max-lg:w-10/12 rounded-lg px-3"
                type="text"
                disabled
                placeholder="unibuzz.college@gmail.com"
              />
            </div>
          )}
        </div>
