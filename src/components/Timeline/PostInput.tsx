...
const PostInput: React.FC<PostInputProps> = ({ setIsModalOpen, setModalContentType }) => {
  ...
  return (
    <div className="flex flex-col gap-3 border-2 border-gray-dark rounded-lg justify-center items-center py-6 lg:max-w-[696px] sm:max-w-md xs:max-w-sm">
      <div className=" flex gap-4">
        <img src="/timeline/avatar.png" alt="User" className="w-12 h-12 sm:w-14 sm:h-14 rounded-full" />
        <div className="flex flex-col gap-3">
          <div className="w-auto border border-gray-light rounded-full py-1 sm:py-2 pr-5 flex">
            <input
              type="text"
              placeholder="Post on your timeline..."
              className="flex-grow mx-1 sm:mx-4 p-2 border-none focus:outline-none lg:min-w-[450px] text-sm"
              value={inputValue}
