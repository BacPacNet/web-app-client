...
const testimonials = [
  ...
  },
  {
    ...
    author: 'Aggarwal College Representative, Dean of Academic Affairs',
    role: 'Aggarwal College',
    ...
    <section className="bg-slate-50 py-16 sm:py-20 lg:py-[100px] px-4" id="testimonials">
      <div className="mx-auto w-full max-width-allowed">
        <SectionHeader
          ...
          align="center"
        />
        <div className=" mt-8 relative mx-auto flex flex-col items-center justify-between max-w-[800px] min-h-[405px] rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-lg ">
