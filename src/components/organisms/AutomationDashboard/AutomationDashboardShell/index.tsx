...
import AutomationDashboardSidebar from '@/components/organisms/AutomationDashboard/AutomationDashboardSidebar'
...
const navItems = [
  { href: '/automation', label: 'Dashboard', requiresUniversity: true },
  { href: '/automation/users', label: 'Users', requiresUniversity: true },
  { href: '/automation/groups', label: 'Groups', requiresUniversity: true },
  { href: '/automation/select-university', label: 'Select University' },
]

export default function AutomationDashboardShell({ title, children }: Props) {
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <div className="grid gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
          <div className="flex flex-col gap-4">
            <AutomationDashboardSidebar pathname={pathname} hasSelectedUniversity={hasSelectedUniversity} items={navItems} />
