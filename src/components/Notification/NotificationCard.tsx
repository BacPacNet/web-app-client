...
const NotificationCard = ({ data }: Props) => {
  ...
  return (
    <div
      ...
      className={`flex flex-col gap-2  border-b-2 border-neutral-200 mx-3 px-6 py-4 hover:bg-neutral-100 bg-neutral-100  transition-all duration-200 cursor-pointer ${
        data?.isRead ? 'bg-surface-primary-50' : 'bg-white'
      }`}
    >
