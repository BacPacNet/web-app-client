...
export default function SectionFour() {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between my-20 gap-14 px-4 sm:px-24 lg:px-0">
      ...
      <div className="lg:w-1/2 flex flex-col items-center sm:items-start text-center sm:text-left justify-start h-full gap-6">
        ...
        <div>
          <p className="font-poppins text-sm sm:text-[32px] font-normal tracking-tighter ">Create new connections and freely message with others.</p>
