...
const GroupChatModal = ({
  ...
  const handleClear = () => {
    ...
    // setFilteredUsers([])
    // setFilteredFacultyUsers([])
    setFilteredAffiliationCount(undefined)
    setFilteredMajorsCount(undefined)
    setFilteredOccupationCount(undefined)
    setFilteredYearsCount(undefined)
    ...
    <div className="relative w-full flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        ...
        <div className={` border-2 border-neutral-200 bg-white flex  items-center justify-center w-[100px] h-[100px] rounded-full`}>
          {groupLogoImage && <img className="w-24 h-24 rounded-full absolute  object-cover" src={URL.createObjectURL(groupLogoImage)} alt="" />}
