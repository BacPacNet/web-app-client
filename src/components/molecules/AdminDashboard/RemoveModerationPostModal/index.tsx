...
import { useDeleteCommunityPostForCommunityAdmin } from '@/services/community-post'
...
export default function RemoveModerationPostModal({ postId, authorName, avatarUrl, initials, avatarColorClass, preview, onSuccess }: Props) {
  const { closeModal } = useModal()
  const [imageFailed, setImageFailed] = useState(false)
  const { mutate: deletePost, isPending } = useDeleteCommunityPostForCommunityAdmin()
