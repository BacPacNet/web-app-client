  ...
  return (
    <div className={`flex min-h-0 flex-col gap-3 ${className}`}>
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-sm">
        <div className="shrink-0 grid grid-cols-[minmax(220px,1.6fr)_minmax(180px,1.2fr)_minmax(150px,1fr)_18px] items-center gap-3 border-b border-neutral-200 bg-neutral-50 px-4 py-3 text-xs font-semibold uppercase tracking-wide text-neutral-500">
          <p>Account</p>
          <p>Email</p>
          <p>Date added</p>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          {isLoading && <AdminTableLoadingState label="Loading admin accounts..." />}
