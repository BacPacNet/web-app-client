...
export default function MobileLeftNavbar({ isOpen, toggleLeftNavbar }: Props) {
  return (
    <>
      ...
      <div
        className={`fixed top-[40px] sm:top-[68px] left-0 z-50 lg:pe-6 p-6 pe-0 h-full w-[284px]  bg-white transition-transform duration-300 transform custom-scrollbar ${
