      ...
      <div className="w-10/12 xl:w-10/12 flex flex-col gap-5 ">
        <div className="relative w-full flex flex-col gap-2">
          ...
          <InputBox
            ...
            err={!!FinalLoginFormErrors.loginEmail}
          />
          {FinalLoginFormErrors.loginEmail && (
            <InputWarningText>
              {FinalLoginFormErrors.loginEmail.message ? FinalLoginFormErrors.loginEmail.message.toString() : 'Please enter your email!'}
            </InputWarningText>
          )}
        </div>
        <div className="relative w-full flex flex-col gap-2">
          ...
          <InputBox
            ...
            err={!!FinalLoginFormErrors.loginPassword}
          />
          <div className={`absolute  right-0 pr-3 flex items-center text-sm ${FinalLoginFormErrors.loginPassword ? 'top-1/3' : 'top-[40%]'} `}>
            {showPassword ? (
          ...
          {FinalLoginFormErrors.loginPassword && <InputWarningText>Please enter your password!</InputWarningText>}
