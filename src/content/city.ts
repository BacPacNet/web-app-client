export const cities: string[] = [
  ...
  'Jounieh',
  'Zouk Mosbeh',
  'Multiple cities including Beirut, Bekaa, Saida, and Tripoli',
  'Mechref',
  'Kushtia',
  'Chittagong',
  'Khulna',
  ...
  'Los Polvorines, Buenos Aires Province',
  'Rosario',
