  ...
  return (
    <main className="max-width-allowed mx-auto md:px-0 px-4 pt-8 pb-4 text-justify">
      ...
      <section className="mb-8">
        <h2 className="font-poppins md:text-4xl text-md-big font-bold text-neutral-700 mb-6">Respectful Content</h2>
      ...
      {/* Authentic Identity */}
      <section className="mb-8">
        <h2 className="font-poppins md:text-4xl text-md-big font-bold text-neutral-700 mb-6">Authentic Identity</h2>
        <ul className="space-y-3 list-disc pl-4 text-neutral-600 font-normal md:text-xs text-2xs mb-16">
          <li className="text-gray-700">
      ...
      <section className="mb-8">
        <h2 className="font-poppins md:text-4xl text-md-big font-bold text-neutral-700 mb-6">Privacy and Security</h2>
        <ul className="space-y-3 list-disc pl-4 text-neutral-600 font-normal md:text-xs text-2xs mb-16">
          <li className="text-gray-700">
      ...
      <section className="mb-8">
        <h2 className="font-poppins md:text-4xl text-md-big font-bold text-neutral-700 mb-6">Intellectual Honesty</h2>
        <ul className="space-y-3 list-disc pl-4 text-neutral-600 font-normal md:text-xs text-2xs mb-16">
      ...
      <section className="mb-8">
        <h2 className="font-poppins md:text-4xl text-md-big font-bold text-neutral-700 mb-6">Appropriate Content Sharing</h2>
        <ul className="space-y-3 list-disc pl-4 text-neutral-600 font-normal md:text-xs text-2xs mb-16">
      ...
      <section className="mb-8">
        <h2 className="font-poppins md:text-4xl text-md-big font-bold text-neutral-700 mb-6">Collaborative Engagement</h2>
        <ul className="space-y-3 list-disc pl-4 text-neutral-600 font-normal md:text-xs text-2xs mb-16">
          <li className="text-gray-700">
      ...
      <section className="mb-8">
        <h2 className="font-poppins md:text-4xl text-md-big font-bold text-neutral-700 mb-6">Compliance & Enforcement</h2>
        <ul className="space-y-3 list-disc pl-4 text-neutral-600 font-normal md:text-xs text-2xs mb-16">
