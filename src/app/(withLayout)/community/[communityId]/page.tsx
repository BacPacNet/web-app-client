...
import { useGetCommunityByToken } from '@/services/community-university'
...
export default function Page({ params }: { params: { communityId: string; groupId: string } }) {
  ...
  const { data: communityData, isLoading: isCommunityLoading } = useGetCommunityByToken(communityId)
