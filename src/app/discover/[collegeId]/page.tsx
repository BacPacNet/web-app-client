...
export default function CollegeDiscovery() {
  const college = {
    ...
    img: 'https://github.com/BacPacNet/web-app-client/blob/BI-64_college_discovery_page/public/demo_cd/img.png?raw=true',
    logo: 'https://github.com/BacPacNet/web-app-client/blob/BI-64_college_discovery_page/public/demo_cd/Logo.png?raw=true',
    contact: {
  ...
  const statsImg = {
    a: 'https://github.com/BacPacNet/web-app-client/blob/BI-64_college_discovery_page/public/demo_cd/1.png?raw=true',
    b: 'https://github.com/BacPacNet/web-app-client/blob/BI-64_college_discovery_page/public/demo_cd/2.png?raw=true',
    c: 'https://github.com/BacPacNet/web-app-client/blob/BI-64_college_discovery_page/public/demo_cd/4.png?raw=true',
    d: 'https://github.com/BacPacNet/web-app-client/blob/BI-64_college_discovery_page/public/demo_cd/3.png?raw=true',
  }
  ...
  return (
    <div className="w-screen min-h-screen bg-white text-black">
      ...
      {/* Image */}
      <div className="relative" style={{ height: '500px', width: '100vw', overflow: 'hidden' }}>
        <Image src={college.img} alt="" layout="fill" objectFit="cover" />
      </div>
      {/* Community Info */}
