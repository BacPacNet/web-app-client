            ...
            <div className="w-screen min-h-screen bg-white text-black">
                ...
                <div className='px-8 lg:px-28 grid grid-cols-1 md:grid-cols-2 justify-center md:justify-between py-10'>
                    <div className='flex flex-row items-center'>
                        <div className='mr-10'><img src="./Logo.png" alt="logo" srcSet="" /></div>
                ...
                <div className=' px-8 md:px-28 flex flex-col justify-between py-10 gap-16'>
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        <span >
                            <p className='py-3'>Nagoya University(名古屋大学,Nagoya daigaku), abbreviated toMeidai(名大)orNU, is aJapanese Research University located in Chikusa-ku, Japan. Nagoya University, since its foundation in 1939, is one of seven imperial universities which has developed into one of the nation’s leading universities. This success is attributed to the liberal and vibrant character of Nagoya University which encourages education and research that is free from traditional and rigid thinking.</p>
                            <p className='py-3'>
                                Nagoya University is one of the top ranked universities in Japan. Here, students and scholars work together, engage in top-notch research to pursue scientific discoveries and invent new state-of-the-art technologies. Six Nobel Prizes have been awarded to scholars associated with Nagoya University.
                            </p>
                            <p className='py-3'>
                                Today, Nagoya University is internationalizing the campus and promoting diversity. For more than a decade, we have offered English-taught programs as an essential part of our mission. Just before the COVID-19 pandemic, the number of international students reached almost 3,000. Students came from over 100 countries and regions. Although the number of students dropped because of the pandemic, the number of applicants for the Global 30 international Programs hit a record high in 2021. We continue to promote internationalization.</p>
                        </span>
                        <span className='text-primary'>Read Less</span>
                    </div>
                    <div className='flex flex-col gap-5'>
                        <span className='flex flex-row gap-1 items-center font-bold'>Contact info <FaCircleInfo /> </span>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-4'>
                        <span className='grid grid-cols-2 text-center justify-center items-center gap-2'>
                            <span className='flex flex-col justify-center items-end p-2'>
                                <span className='bg-primary text-white px-1 text-center rounded-lg mr-2'>Score</span><span className='text-4xl font-bold'>7.34</span>
                            </span>
                        ...
                        <span className="hidden md:flex flex-row justify-center items-center  mx-auto">
                            <button className='bg-gray-light text-primary py-3 px-5 rounded-md'>Add a review</button></span>
                        <span className='flex flex-row justify-center items-center'><ul className='flex flex-row gap-4'>
                            <li><FaStar size={20} color='orange' /></li>
                            <li><FaStar size={20} color='orange' /></li>
                            <li><FaStar size={20} color='orange' /></li>
                            <li><FaStar size={20} color='orange' /></li>
                            <li><FaStar size={20} color='orange' /></li>
                            <li><FaStar size={20} color='orange' /></li>
                            <li><FaStar size={20} color='orange' /></li>
                            <li><FaStar size={20} color='gray' /></li>
                            <li><FaStar size={20} color='gray' /></li>
                            <li><FaStar size={20} color='gray' /></li>
                        </ul></span>
                        <span className='flex flex-row justify-center items-center text-gray'>from 1000+ reviews</span>
                        <span className=" md:hidden flex-row justify-center items-center mx-auto"><button className='bg-gray-light text-primary py-3 px-5 rounded-md'>Add a review</button></span>
