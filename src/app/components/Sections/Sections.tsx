        ...
        <Parallax strength={600}>
            <div className="section-1 bg-[#F3F2FF] flex flex-col items-center" >
                <div className="heading flex justify-center flex-col items-center">
                    ...
                    <h3 className="h-section-1 font-inter flex justify-center font-extrabold text-4xl leading-12 tracking-tight text-center text-[#171717]">Search your institute</h3>
                </div>
